...
export type CreateTeamWorkspaceResponse =
  | CreateTeamWorkspaceError
  | CreateTeamWorkspaceSuccess;
...
export type GetTicketsForContractsResponse =
  | GetTicketsForContractsError
  | GetTicketsForContractsSuccess;
...
export type Mutation = {
  ...
  loginAdminUser: LoginUserResponse;
...
export type CreateCompanyMutation = {
  __typename?: 'Mutation';
  createCompany:
    | { __typename?: 'CreateCompanyError'; message: string; success: boolean }
    | {
        __typename?: 'CreateCompanySuccess';
        companyID: string;
        success: boolean;
...
export type IntrospectionQueryQuery = {
  ...
  __schema: {
    __typename?: '__Schema';
    queryType: { __typename?: '__Type'; name?: string | null | undefined };
    mutationType?:
      | { __typename?: '__Type'; name?: string | null | undefined }
      | null
      | undefined;
    subscriptionType?:
      | { __typename?: '__Type'; name?: string | null | undefined }
...
export type HoldTicketMutation = {
  __typename?: 'Mutation';
  holdTicket:
    | { __typename?: 'HoldTicketError'; success: boolean; message: string }
    | { __typename?: 'HoldTicketSuccess'; success: boolean; ticketID: string };
};
...
export type CreateUserMutation = {
  __typename?: 'Mutation';
  createUser:
    | { __typename?: 'CreateUserError'; success: boolean; message: string }
    | { __typename?: 'CreateUserSuccess'; success: boolean; userID: string };
};
...
export type LoginAdminUserMutation = {
  __typename?: 'Mutation';
  loginAdminUser:
    | { __typename?: 'LoginUserFailed'; success: boolean; message: string }
    | { __typename?: 'LoginUserSuccess'; success: boolean; token: string };
};
...
export type GetAdminUserQuery = {
  __typename?: 'Query';
  getAdminUser:
    | { __typename?: 'GetUserError'; message: string; success: boolean }
    | {
        __typename?: 'GetUserSuccess';
        user: {
          __typename?: 'User';
...
`;
export type HoldTicketMutationFn = Apollo.MutationFunction<
  HoldTicketMutation,
  HoldTicketMutationVariables
>;
 ...
 * });
 */
export function useHoldTicketMutation(
  baseOptions?: Apollo.MutationHookOptions<
    HoldTicketMutation,
    HoldTicketMutationVariables
  >,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<HoldTicketMutation, HoldTicketMutationVariables>(
    HoldTicketDocument,
    options,
  );
}
export type HoldTicketMutationHookResult = ReturnType<
  typeof useHoldTicketMutation
>;
export type HoldTicketMutationResult =
  Apollo.MutationResult<HoldTicketMutation>;
export type HoldTicketMutationOptions = Apollo.BaseMutationOptions<
  HoldTicketMutation,
  HoldTicketMutationVariables
>;
...
export function useLoginAdminUserMutation(
  ...
  return Apollo.useMutation<
    LoginAdminUserMutation,
    LoginAdminUserMutationVariables
  >(LoginAdminUserDocument, options);
}
export type LoginAdminUserMutationHookResult = ReturnType<
  typeof useLoginAdminUserMutation
>;
export type LoginAdminUserMutationResult =
  Apollo.MutationResult<LoginAdminUserMutation>;
